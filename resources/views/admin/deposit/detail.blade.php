...
@section('panel')
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button
                                    ...
                                    data-bs-target="#acceptDepositModal{{$deposit->id}}"
                                    >
    ...
    <div id="acceptDepositModal{{$deposit->id}}" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Accept Deposit Confirmation</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                ...
                <form
                    action="{{ route('admin.deposit.approve', $deposit->id) }}"
                    method="POST"
                    >
                    @csrf
                    <div class="modal-footer">
